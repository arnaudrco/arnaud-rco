...
// interface MIDI pour batterie à 5 cymbales
// sur PC http://projectgus.github.io/hairless-midiserial/
// version arduino nano 3.0
...
#define NBDRUMS 4 // nombre de cymbale - 1 
